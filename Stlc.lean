...
Reads each file (or every `.stlc` file under a directory), parses it, elaborates it, and writes the result back out with every metavariable
...
def main (args : List String) : IO UInt32 :=
  cli "stlc" "stlc" stlcLanguage.compileElab args
