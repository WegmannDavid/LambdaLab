...
structure ElaboratableLanguage extends Language where
  /-- Deciding type equality — the application rule compares types. -/
...
attribute [instance] ElaboratableLanguage.tyDecEq ElaboratableLanguage.tyHasSubst
  ElaboratableLanguage.tmHasSubst ElaboratableLanguage.ctxHasSubst
